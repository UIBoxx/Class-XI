import 'package:classxii/pages/english.dart';
import 'package:classxii/pages/nepali.dart';
import 'package:classxii/pages/social.dart';
import 'package:classxii/screens/drawer.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    final Uri toTelegram =
        Uri(scheme: 'https', host: 't.me', path: 'nepalenotes11science');
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Class-XI Notes '),
        elevation: 0,
      ),
      drawer: MyDrawer(
